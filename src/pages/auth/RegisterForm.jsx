...
function RegisterForm() {
	...
	return (
		<section
			className="w-full md:full-height relative flex-column md:grid md:justify-center grid-cols-auth overflow-hidden max-sm:gap-8"
			id="register"
		>
			<div className="w-full hidden md:block full-height bg-green-300">
